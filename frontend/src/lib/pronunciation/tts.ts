...
export const ACCENT_LANGS: Record<Accent, string> = {
  us: 'en-US',
  uk: 'en-GB',
  au: 'en-AU',
};
...
export const RATE_OPTIONS = [0.5, 0.75, 0.9, 1, 1.25] as const;
...
export const getVoice = (accent: Accent): SpeechSynthesisVoice | null => {
